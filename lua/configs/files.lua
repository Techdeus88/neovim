...
function F.open_config()
  ...
  F.files_set_cwd_with_path(config_path)
end
...
local function get_icon(bufnr, filetype)
  if not is_buf_valid(bufnr) then
    return nil
  end
  -- Your logic to get the icon based on filetype
end

-- Function to get icon color
local function get_icon_color(bufnr, filetype)
  if not is_buf_valid(bufnr) then
    return nil
  end
  -- Your logic to get the icon color based on filetype
end

-- Example usage
F.get_icon = function(bufnr, filetype)
  return get_icon(bufnr, filetype)
end

F.get_icon_color = function(bufnr, filetype)
  return get_icon_color(bufnr, filetype)
end
